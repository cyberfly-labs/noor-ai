function(download_simple_sentencepiece)
  ...
  if(ANDROID)
    find_library(SSENTENCEPIECE_CXX_SHARED c++_shared)
    find_library(SSENTENCEPIECE_CXXABI c++abi)

    if(SSENTENCEPIECE_CXX_SHARED)
      target_link_libraries(ssentencepiece_core PUBLIC ${SSENTENCEPIECE_CXX_SHARED})
    else()
      target_link_libraries(ssentencepiece_core PUBLIC c++_shared)
    endif()

    if(SSENTENCEPIECE_CXXABI)
      target_link_libraries(ssentencepiece_core PUBLIC ${SSENTENCEPIECE_CXXABI})
    endif()
  endif()
